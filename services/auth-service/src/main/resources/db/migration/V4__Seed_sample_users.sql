...
-- Sample users for testing (password: "password" for all)

INSERT INTO "USER" (client_id, username_or_email, password_hash, role, two_factor_enabled) VALUES
(1, 'admin@cashtactics.com', '$2a$10$dXJ3SW6G7P50lGmMkkmwe.20cQQubK3.HZWzG3YB1tlRy.fqvM/BG', 'ADMIN', false),
(2, 'user@cashtactics.com', '$2a$10$dXJ3SW6G7P50lGmMkkmwe.20cQQubK3.HZWzG3YB1tlRy.fqvM/BG', 'USER', false),
