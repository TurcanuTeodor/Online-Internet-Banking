...
public class PaymentControllerIT {
    ...
    @Test
    public void clientCannotAccessOtherClientPayments() throws Exception {
    ...
    @Test
    public void adminCanAccessAnyClientPayments() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/payments/by-client/999")
    ...
    @Test
    public void clientCanAccessOwnPayments() throws Exception {
